...
public class TestCaseColorManager {
	private static TestCaseColorManager standalone;
	private Map<RGB, Color> fColorTable = new HashMap<>(10);

	public TestCaseColorManager() {
	 ...
	 */
	public static TestCaseColorManager getStandalone() {
		if (standalone==null){
	 ...
	 * @param standalone
	 */
	public static void setStandalone(TestCaseColorManager standalone) { // NO_UCD (test only)
		TestCaseColorManager.standalone = standalone;
	}
