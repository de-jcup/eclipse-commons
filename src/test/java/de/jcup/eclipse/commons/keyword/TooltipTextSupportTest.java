...
public class TooltipTextSupportTest {
	...
	@Test
	public void support_get_defined_tooltiptext_returns_not_empty_string() {
		/* execute */
		String result = supportToTest.get("defined_tooltiptext");
		/* test */
		assertFalse(result.isEmpty());
	}
	
	@Test
	public void support_get_defined_tooltiphtml_returns_not_empty_string() {
		/* execute */
		String result = supportToTest.get("defined_tooltiphtml");
		/* test */
		assertFalse(result.isEmpty());
	}
	...
	private static class TestResourceInputstreamProvider implements ResourceInputStreamProvider{
		...
		private static File TOOLTIPS_FOLDER = new File("./src/test/resources/tooltips");
		static{
			if (!TOOLTIPS_FOLDER.exists()){
				/* gradle */
				TOOLTIPS_FOLDER=new File("./eclipse-commons/src/test/resources/tooltips");
			}
		}
		@Override
